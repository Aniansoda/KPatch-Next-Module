    ...
    try {
        ...
        sortedApps.forEach(app => {
            ...
            if (!item) {
                ...
                item.className = 'app-item liquid-glass';
                ...
                const extraTagsHtml = extraTags.length > 0 ? `
                    <div class="tag-wrapper">
                        ${extraTags.map(tag => `<div class="tag liquid ${app.isSystem ? 'system' : ''}">${tag}</div>`).join('')}
                    </div>
                ` : '';
                ...
                item.innerHTML = `
                    ...
                    <md-switch class="app-switch liquid"></md-switch>
                `;
...
function initExcludePage() {
    ...
    systemAppCheckbox.classList.add('liquid-glass');
    refreshBtn.classList.add('liquid');
    ...
    if (appListContainer) {
        appListContainer.classList.add('liquid-glass');
    }
