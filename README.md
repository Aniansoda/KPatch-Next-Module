...
- magiskboot binay from [Magisk](https://github.com/topjohnwu/Magisk)
...
- magiskboot binay from Magisk is licenced under GNU General Public License v3 [GPL-3.0](https://github.com/topjohnwu/Magisk/blob/master/LICENSE)
